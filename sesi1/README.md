...
- **Visual Kotak Interaktif:** Membuka kotak dengan tampilan emoji (`[🐹]` untuk posisi marmut dan `[❌]` untuk kotak yang salah).
...
python3 main6.py
\`\`\`
*(Atau `python main6.py` tergantung konfigurasi komputermu)*
